...
def main():
    src = "duanping"
    path = OUT / r"F:\\even-codex\\lianghua+IMA\\backtest_output\\zsxq_group_15552822254242.json"
    if not path.exists(): path = _PROJ / "data" / r"F:\\even-codex\\lianghua+IMA\\backtest_output\\zsxq_group_15552822254242.json"
